    ...
    <div className="home-container">
        <div className="main-slider slider slick-initialized slick-slider">
            <div
                class="slider-item"
                style="
                    background-image: url('src/assets/images/slideshow1-2.jpg');
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 offset-lg-6 offset-md-6">
                            <div class="slider-caption">
                                ...
                                <h1 class="mt-2 mb-5">
                                    <span class="text-color">Winter </span
                                    >Collection
                                </h1>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12 col-md-6">
                        <div class="cat-item mb-4 mb-lg-0">
                            <img
                                src="src/assets/images/cat-1.jpg"
                                alt=""
                                class="img-fluid"
                            />
                            <div class="item-info">
                    ...
                    <div class="col-lg-4 col-sm-12 col-md-6">
                        <div class="cat-item mb-4 mb-lg-0">
                            <img
                                src="src/assets/images/cat-2.jpg"
                                alt=""
                                class="img-fluid"
                            />
                    ...
                    <div class="col-lg-4 col-sm-12 col-md-6">
                        <div class="cat-item">
                            <img
                                src="src/assets/images/cat-3.jpg"
                                alt=""
                                class="img-fluid"
                            />
                            <div class="item-info">
                            ...
                            <div class="product-wrap">
                                <a href="/productdetails"
                                    ><img
                                        ...
                                        src="src/assets/images/322.jpg"
                                        alt="product-img"
                                /></a>
                                <a href="/productdetails"
                                    ><img
                                        class="img-fluid w-100 mb-3 img-second"
                                        src="src/assets/images/444.jpg"
                                        alt="product-img"
                                /></a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-sm-12 col-md-12">
                        <img
                            src="src/assets/images/adsv.jpg"
                        ...
                        <div class="widget-featured-entries mt-5 mt-lg-0">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="featured-entry-title mb-0">
                                        <a href="#"
                                            >Nike - Brasilia Medium Backpack</a
                                        >
                                    </h6>
