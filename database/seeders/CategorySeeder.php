...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            ' موبایل' => ['گوشی موبایل' => ['برند' => [1 => 'Apple', 2 => 'Samsung'], 'رزولوشن عکس' => [1 => '68px', 2 => '48px'], 'حافظه داخلی' => [1 => '64g', 2 => '128g'], 'RAM' => [1 => '2g', 2 => '4g', 3 => '6g', 4 => '8g']], 'لوازم چانبی موبایل' => ['برند' => [1 => 'Dala', 2 => 'Dilo']]],
