...
<template>
    <div class="flex flex-col items-center justify-start min-h-screen bg-gray-100">
        ...
        <div class="flex items-center justify-between my-3 space-x-6 shadow-md w-2/3">
                ...
                <Dropdown align="right" width="44">
                    ...
                    <template #content>
                        <div v-for="category of categories">
                            <input type="radio" v-model="filter_category" name="option" :id="category.id"
            ...
            <div class="flex py-3 px-4 rounded-lg text-gray-100 font-semibold cursor-pointer">
                <Dropdown align="right" width="44">
                    <template #trigger>
                    ...
                    <template #content>
                        ...
                        <div>
                            <input type="radio" v-model="order_by" name="option" id="143" value="rate"
                                class="peer hidden" />
                            <label for="143"
                        ...
                        <div>
                            <input type="radio" v-model="order_by" name="option" id="144" value="most_visited"
                                class="peer hidden" />
                            <label for="144"
                        ...
                        <div>
                            <input type="radio" v-model="order_by" name="option" id="145" value="newest"
                                class="peer hidden" />
                            <label for="145"
                        ...
                        <div>
                            <input type="radio" v-model="order_by" name="option" id="146" value="bestselling"
                                class="peer hidden" />
                            <label for="146"
        ...
        <table class=" text-gray-400  w-2/3 text-sm">
            ...
            <tbody>
                <tr v-for="product of products.data" :key="product.id" class="bg-gray-200 mx-3 py-1">
                    <td class="p-3">
                        <div class="flex items-center">
                            <img class="rounded-full h-12 w-12  object-cover"
                                ...
                                alt="unsplash image">
                            <div class="ml-3">
                                <div class="text-yellow-900">{{ product.title }}</div>
                            </div>
                        </div>
                    </td>
