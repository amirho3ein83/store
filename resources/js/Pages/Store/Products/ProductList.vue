...
let price_range = useStorage("price_range");
...
watch(
    ...
    debounce(function (value) {
        Inertia.get(
            window.location.href,
            { order_by: order_by.value, search: search.value,price_range:value },
            {
                replace: true,
                preserveState: true,
                preserveScroll: true,
...
// watch(searchData, (newValues, oldValues) => {
//     const { search, order_by, price_range, additionalProperty } = newValues;
//     handleSearchChange(search, order_by, price_range, additionalProperty);
// });

// function handleSearchChange(searchValue, orderByValue, priceRangeValue, additionalValue) {
//     Inertia.post(
//         window.location.href,
//         { order_by: orderByValue, search: searchValue, price_range: priceRangeValue, additional_property: additionalValue },
//         {
//             replace: true,
//             preserveState: true,
//             preserveScroll: true,
    ...
    return [
        ...
        },
        {
            ...
            url: route("subCategories.list", {
                category: props.category.parentCategory.slug,
            }),
            disable: false,
        },
        {
    ...
    <div class="bg-white">
        <div>
            ...
            <main class="mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div
                    class="flex items-baseline justify-between border-b border-gray-200 py-3 pt-0"
                >
                    <Breadcrumb
                        class="p-5"
                        :crumbs="crumbItems"
                        @selected="crumbSelected()"
                    />
                ...
                <section aria-labelledby="products-heading" class="pt-6 pb-24">
                    ...
                    <div class="flex w-full">
                        ...
                        <form
                            @submit.prevent
                            id="filterForm"
                            class="hidden lg:block lg:w-1/6 grow self-start sticky top-0 col-span-1"
                        >
                            <div
                            ...
                            >
                                ...
                                <h1
                                    class="text-lg hidden sm:block font-semibold tracking-tight"
                                >
