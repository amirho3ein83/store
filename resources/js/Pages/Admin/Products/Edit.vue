...
<template>
    ...
    <div class="min-h-screen p-6 bg-gray-100 flex justify-center">
        <div class="container max-w-screen-xl mx-auto">
            <div>
                <div class="bg-[#d9dadb] rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <div class="flex gap-x-12">
                        <!-- preview card -->
                        <div class="text-gray-600 w-1/3">
                            <div class="flex px-1 flex-col justify-center items-center my-2">
                                <img v-if="!newImage" :src="defaultImage" alt=""
                                    class="h-[300px] w-full shadow-lg spacity-20 object-cover sm:h-[350px]" />
                                <img v-else :src="newImage" alt=""
                                    class="h-[300px] w-full shadow-lg spacity-20 object-cover sm:h-[350px]" />
                            ...
                            <form @submit.prevent="addproduct" class="space-y-4" enctype="multipart/form-data">
                                <div class="-mx-3 md:flex mb-2 justify-between">
                                    <div class="flex flex-col">
                                        ...
                                        <div>
                                            ...
                                            <JetInputError class="mt-2" :message="form.errors.image" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-between" v-for="category of categories"
                                                :key="category.id">
                                                {{ category.name }}
                                                <input type="checkbox" :value="category.id" v-model="
                                                    form.picked_categories
                                                " name="" id="" />
                                            </div>
                                        </div>
                                        <JetInputError class="mt-2" :message="form.errors.categories" />
                                    </div>
                                </div>
                                ...
                                <div class="flex">
                                    <div class="md:w-full px-3">
                                        ...
                                        <JetInputError class="mt-2" :message="form.errors.details" />
                                    </div>
                                    <div class="md:w-full px-3">
                                        <label class="block text-grey-darker text-sm font-bold mb-2">
                                            توضیحات
                                ...
                                <div class="border-y-4 pb-6 pt-2">
                                    ...
                                    <div class="flex">
                                        <div class="w-2/3">
                                            <div class="flex gap-1 border-b-6 items-center w-full" v-for="(
                                                            priceGroup, index
                                                        ) of state.productColors" :key="index">
                                                <!-- color combo box -->
                                        ...
                                        <div class="w-1/3">
                                            <button @click="addPriceGroup()" type="button"
                                ...
                                <div class="border-b-4 pb-6 pt-2">
                                    ...
                                    <div class="flex">
                                        <div class="w-2/3">
                                            <div class="flex gap-1 border-b-6 items-center w-full" v-for="(
                                                            attr, index
                                                        ) of state.productAttributes" :key="index">
                                                <div class="md:w-full">
                                                    عنوان
                                                    <input type="text" v-model="attr.title"
                                                        class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-2 px-4 mb-3" />
                                                </div>
                                        ...
                                        <div class="w-1/3">
                                            <button @click="addProductAttribute()" type="button"
                                                class="inline-flex text-lg items-center px-3 py-1 bg-green-600 hover:scale-105 active:scale-100 duration-150 transition-all text-gray-100 font-medium rounded-md">
                                                + اضافه کردن
                                            </button>
                                        </div>
                                ...
                                <div class="flex justify-end mt-4">
                                    <PrimaryButton class="ml-4 bg-stone-600 text-lg px-10" :class="{
