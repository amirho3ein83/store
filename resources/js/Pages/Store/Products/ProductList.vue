                        ...
                        <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                            ...
                            <DialogPanel
                                ...
                                <form @submit.prevent class="mt-4 border-t border-gray-200">
                                    <Disclosure as="div" v-for="section in filterLabels" :key="section.id"
                                        ...
                                        <DisclosurePanel class="pt-6">
                                            ...
                                            <div class="space-y-4">
                                                <div v-for="option of section.options" :key="option.slug"
                                                    class="flex items-center">
                                                    <input :id="`filter-${section.id}-${option.id}`"
                                                        :name="`${section.slug}[]`" :value="option.slug" type="checkbox"
                                                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                    <label :for="`filter-${section.id}-${option.id}`"
                        ...
                        <div class="flex items-center">
                                ...
                                <transition enter-active-class="transition ease-out duration-100"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="py-1">
                                            ...
                                            <div>
                                                <input type="radio" name="option" v-model="order_by" :id="option.value"
                                                    :value="option.value" class="peer hidden" />
                                                <label :for="option.value" v-text="option.name"
                            ...
                            <button type="button"
                                ...
                                <!-- <FunnelIcon
                                    ...
                                    aria-hidden="true"
                                /> -->
                                <button class="h-8 w-8 text-slate-800" aria-hidden="true">
                            ...
                            <Disclosure as="div" v-for="section in filterLabels" :key="`attr-${section.slug}`"
                                ...
                                <h3 class="-my-3 flow-root">
                                    <DisclosureButton
                                        ...
                                        <span class="font-medium text-slate-800 text-md sm:text-lg">{{ section.name
                                        }}</span>
                                    </DisclosureButton>
                                </h3>
                                <DisclosurePanel class="pt-6">
