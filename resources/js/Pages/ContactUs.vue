    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <p class="text-gray-100 text-body-color mb-9 text-base leading-relaxed">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-gray-100  mb-1 text-xl font-bold">Our Location</h4>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-gray-100  mb-1 text-xl font-bold">Phone Number</h4>
              <p class="text-gray-100 text-body-color text-base">(+62)81 414 257 9980</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-gray-100  mb-1 text-xl font-bold">Email Address</h4>
              <p class="text-gray-100 text-body-color text-base">info@yourdomain.com</p>
            </div>
          </div>
        </div>
      </div>
      <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div class="relative rounded-lg bg-gray-500 p-8 shadow-lg sm:p-8">
          <form>
            <div class="mb-6">
              <input
                type="text"
            ...
            <div>
              <button
                type="submit"
                class="bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-gray-900 bg-gray-700"
              >
                Send Message
              </button>
            </div>
